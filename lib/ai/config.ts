...
export const DEFAULT_GROQ_INTERVIEW_MODEL = 'openai/gpt-oss-20b';
...
export function resolveGroqConfig(bindings: GroqEnvironment = {}, processEnvironment: GroqEnvironment = {}) {
  return {
    ...
    interviewModel: bindings.GROQ_INTERVIEW_MODEL || processEnvironment.GROQ_INTERVIEW_MODEL || DEFAULT_GROQ_INTERVIEW_MODEL,
